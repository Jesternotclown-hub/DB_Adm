...
После была выполнена команда pg_restore -U vasologubova -d circus_restore -h localhost -p 5433 backup_circus.dump, которая позволяет восстановить структуру базы данных, схемы, таблицы и все записи из резервной копии backup_circus.dump в новую базу circus_restore.
